package com.htecgroup.flightadvisor.security.jwt;
...
public class TokenProvider {
    ...
    public void init() {
        byte[] keyBytes;
        String base64Secret = applicationProperties.getSecurity()
                .getBase64Secret();
        keyBytes = Decoders.BASE64.decode(base64Secret);
        this.key = Keys.hmacShaKeyFor(keyBytes);
        this.tokenValidityInMilliseconds = 1000 * applicationProperties.getSecurity()
